...
| `modules/frontend` | Next.js / React web application with split-screen layout, subtitle bar, interactive question overlays, and live pedagogy audit feed. | `modules/frontend/docs/frontend_detail.md` | Pending implementation | `.gitkeep` |
...
- **Status**: **Pending Implementation** (Next planned phase).
